...
/// @tparam ByteOrderPolicy   [typename] The byte-order that is used to 
///                           encode the data into the buffer. All I/O operations
///                           on the buffer must be in the order specified
///                           by this policy.
///
